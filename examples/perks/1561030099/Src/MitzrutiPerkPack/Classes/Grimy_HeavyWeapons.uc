class Grimy_HeavyWeapons extends X2Item config(MZPerkWeapons);
...
var config int FLAMETHROWERMK2_RADIUS, PocketFlameBurnSpread, PocketFlameBurnDamage;
...
static function X2WeaponTemplate GrimyShredderGun()
{
	...
	Template.Abilities.AddItem('FireGrimyShredderGun');
...
static function X2WeaponTemplate GrimyFlamethrower()
{
	...
	Template.Abilities.AddItem('FireGrimyFirewall');
...
static function X2WeaponTemplate RocketLauncher()
{
	...
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MZSevenRocketLauncher');
	Template.WeaponCat = 'heavy';
	...
	Template.Abilities.AddItem('FireMZPocketRocketLauncher');
...
static function X2WeaponTemplate FlamethrowerMk2()
{
	...
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MZSevenFlamethrower');
	Template.WeaponCat = 'heavy';
	...
	Template.Abilities.AddItem('FireMZPocketFlamethrower');
...
static function X2WeaponTemplate BlasterLauncher()
{
	...
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MZSevenBlasterLauncher');
	Template.WeaponCat = 'heavy';
	...
	Template.Abilities.AddItem('FireMZPocketBlasterLauncher');
	Template.Abilities.AddItem('RocketFuse');
...
static function X2WeaponTemplate PlasmaBlaster()
{
	...
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MZSevenPlasmaBlaster');
	Template.WeaponCat = 'heavy';
	...
	Template.Abilities.AddItem('FireMZPocketPlasmaBlaster');
...
static function X2WeaponTemplate ShredstormCannon()
{
	...
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MZSevenShredstormCannon');
	Template.WeaponCat = 'heavy';
	...
	Template.Abilities.AddItem('FireMZPocketShredderGun');
