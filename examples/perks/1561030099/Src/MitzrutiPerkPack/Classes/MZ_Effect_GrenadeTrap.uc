class MZ_Effect_GrenadeTrap extends X2Effect_Persistent config(GameData);
...
function RegisterForEvents(XComGameState_Effect EffectGameState)
{
	...
	EventMgr.RegisterForEvent(EffectObj, 'ObjectMoved', MZ_Helper_EffectGS(EffectGameState).GrenadeTrap_ObjectMoved, ELD_OnStateSubmitted);
	EventMgr.RegisterForEvent(EffectObj, 'AbilityActivated', MZ_Helper_EffectGS(EffectGameState).GrenadeTrap_AbilityActivated, ELD_OnStateSubmitted);
}
