class MZ_Effect_ShiverOnCrit extends X2Effect_Persistent;
...
function RegisterForEvents(XComGameState_Effect EffectGameState)
{
	...
	EventMgr.RegisterForEvent(EffectObj, 'AbilityActivated', class'MZCryoshot_AbilitySet'.static.AbilityTriggerEventListener_ShiverOnCrit, ELD_OnStateSubmitted, 40, SourceUnitState);
}

DefaultProperties
{
    EffectName="MZ_Shiver_Effect"
