class MZ_TargetingMethod_GlacialSpike extends X2TargetingMethod_Grenade;
...
function Update(float DeltaTime)
{
	...
	if( NewTargetLocation != CachedTargetLocation )
	{
		...
		if( ValidateTargetLocations(TargetLocations) == 'AA_Success' )
		{
			...
			//would like to draw the tile you teleport to as blue.
...
//basically just to add the inability to target ramp tiles, consistent with pillar.
