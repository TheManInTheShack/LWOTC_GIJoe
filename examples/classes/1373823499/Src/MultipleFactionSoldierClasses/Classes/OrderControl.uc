//OrderControl.uc (Standalone) revision 1.1a (for MFSC)
...
static function X2DownloadableContentInfo_MultipleFactionSoldierClasses GetThisInstance() {
	return X2DownloadableContentInfo_MultipleFactionSoldierClasses(GetMyInstance("MultipleFactionSoldierClasses"));
}
